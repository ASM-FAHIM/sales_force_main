...
class _Advance_adjust_NotificationState
  ...
  Future<List<AdvanceAdjustNotiModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse(
            'http://172.20.20.69/adminnotification/neptune/advanceadj.php'),
                          ...
                          child: ExpansionTile(
                            title: Row(
                              ...
                              children: [
                                ...
                                // Text("${snapshot.data![index].qeqnum}",
                                //   style: GoogleFonts.bakbakOne(
                                //     fontSize: 18,
                                //     //color: Color(0xff074974),
                                //   ),
                            ...
                            children: <Widget>[
                              ...
                              // Text("Purchase Type : "+"${snapshot.data![index].xtype}",
                              //   style: GoogleFonts.bakbakOne(
                              //     fontSize: 18,
                              //     //color: Color(0xff074974),
                              //   ),
                                ...
                                children: [
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      var response = await http.post(
                                          Uri.parse(
                                              'http://172.20.20.69/adminapprove/advanceadjapprove.php'),
                                          body: jsonEncode(<String, String>{
                                            "zid": widget.zid,
                                            "user": widget.zemail,
                                            "xposition": widget.xposition,
                                              ...
                                              actions: [
                                                TextButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    var response = await http.post(
                                                        Uri.parse(
                                                            'http://172.20.20.69/adminapprove/advanceadjreject.php'),
                                                        body: jsonEncode(<
                                                            String, String>{
                                                          "zid": widget.zid,
                                                          "user": widget.zemail,
