...
import '../../../../data_model/notification_model/admin_approver_model/special/legal_activities_noti_model.dart';

class Legal_activities_Notification extends StatefulWidget {
  ...
  @override
  _Legal_activities_NotificationState createState() =>
      _Legal_activities_NotificationState();
}

class _Legal_activities_NotificationState
    extends State<Legal_activities_Notification> {
  // fetchnotification _noteList = fetchnotification();
  //fetchnotification _noteList = fetchnotification();

  @override
  Future<List<LegalActivitiesNotiModel>>? futurePost;

  String Note = " ";

  Future<List<LegalActivitiesNotiModel>> fetchPost() async {
    var response = await http.post(
        Uri.parse('http://172.20.20.69/adminnotification/legalactive.php'),
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<LegalActivitiesNotiModel>(
              (json) => LegalActivitiesNotiModel.fromJson(json))
          .toList();
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<LegalActivitiesNotiModel>>(
          future: futurePost,
                                ...
                                children: [
                                  TextButton(
                                    ...
                                    onPressed: () async {
                                      var response = await http.post(
                                          Uri.parse(
                                              'http://172.20.20.69/adminapprove/legalactivereject.php'),
                                          body: jsonEncode(<String, String>{
                                            "zid": widget.zid,
                                            "user": widget.zemail,
                                            "xposition": widget.xposition,
