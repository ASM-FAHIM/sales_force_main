...
//
// class PendingSpplierApprovalNotification extends StatefulWidget {
//   PendingSpplierApprovalNotification(
...
//
//   @override
//   State<PendingSpplierApprovalNotification> createState() =>
//       _PendingSpplierApprovalNotificationState();
// }
//
// class _PendingSpplierApprovalNotificationState
//     extends State<PendingSpplierApprovalNotification> {
//   Future<List<DcAdminModel>>? futurePost;
//   dynamic rejectNote = " ";
//
//   Future<List<DcAdminModel>> fetchPost() async {
//     var response = await http.post(Uri.parse(ConstApiLink().pendingSupplierApi),
