...
List<BatpModel> batpModelFromJson(String str) =>
    List<BatpModel>.from(json.decode(str).map((x) => BatpModel.fromJson(x)));

String batpModelToJson(List<BatpModel> data) =>
...
class Xdate {
  ...
  factory Xdate.fromJson(Map<dynamic, dynamic> json) => Xdate(
