...
List<BmpModel> bmpModelFromJson(String str) =>
    List<BmpModel>.from(json.decode(str).map((x) => BmpModel.fromJson(x)));

String bmpModelToJson(List<BmpModel> data) =>
