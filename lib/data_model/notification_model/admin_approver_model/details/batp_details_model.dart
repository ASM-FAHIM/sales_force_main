...
//
//     final batpDetailsModel = batpDetailsModelFromJson(jsonString);

import 'dart:convert';

List<BatpDetailsModel> batpDetailsModelFromJson(String str) =>
    List<BatpDetailsModel>.from(
        json.decode(str).map((x) => BatpDetailsModel.fromJson(x)));

String batpDetailsModelToJson(List<BatpDetailsModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class BatpDetailsModel {
  BatpDetailsModel({
    required this.descr,
    required this.unit,
    required this.ztime,
  ...
  factory BatpDetailsModel.fromJson(Map<String, dynamic> json) =>
      BatpDetailsModel(
        descr: json["descr"],
        unit: json["unit"],
