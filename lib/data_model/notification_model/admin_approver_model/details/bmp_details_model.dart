...
//
//     final bmpDetailsModel = bmpDetailsModelFromJson(jsonString);

import 'dart:convert';

List<BmpDetailsModel> bmpDetailsModelFromJson(String str) =>
    List<BmpDetailsModel>.from(
        json.decode(str).map((x) => BmpDetailsModel.fromJson(x)));

String bmpDetailsModelToJson(List<BmpDetailsModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class BmpDetailsModel {
  BmpDetailsModel({
    required this.descr,
    required this.ztime,
  ...
  factory BmpDetailsModel.fromJson(Map<String, dynamic> json) =>
      BmpDetailsModel(
        descr: json["descr"],
        ztime: json["ztime"],
        zutime: json["zutime"],
